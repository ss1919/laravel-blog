                            ...
                            <ul class="topbar-link">
                                ...
                                @auth
                                    ...
                                    @if (Auth::user()->is_admin)
                                        <li><a href="{{ route('admin.index') }}" title="">Admin Panel</a></li>
                                    @endif
                                @else
                                    <li><a href="{{ route('login') }}" title="">Login</a> / <a
                                            href="{{ route('registration.create') }}" title="">Register</a></li>
                                @endauth
        ...
        <nav class="navbar navbar-hover navbar-expand-lg navbar-soft">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="main_nav99">
                    ...
                    <ul class="navbar-nav">
                        <li>
                            <a href="{{ route('registration.create') }}" class="btn btn-primary text-capitalize">
                                <i class="fa fa-plus-circle mr-1"></i> add post</a>
                        </li>
                    </ul>
                    <!-- Search content bar.// -->
